...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'caption',
            type:'text',
            rect:['519px','408px','115px','17px','auto','auto'],
            text:"Slide 1",
            font:['Georgia, Times New Roman, Times, serif',12,"rgba(245,240,240,1.00)","normal","none",""]
         },
         {
            id:'slideshow1',
            type:'image',
            rect:['501px','0px','503px','400px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"slideshow1.png",'0px','0px']
         },
         {
            id:'slideshow2',
            display:'none',
            type:'image',
            rect:['501px','0px','503px','400px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"slideshow2.png",'0px','0px']
         },
         {
            id:'slideshow3',
            display:'none',
            type:'image',
            rect:['501px','0px','503px','400px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"slideshow3.png",'0px','0px']
         },
         {
            id:'slideshow4',
            display:'none',
            type:'image',
            rect:['501px','0px','503px','400px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"slideshow4.png",'0px','0px']
         },
         {
            id:'slideshow5',
            display:'none',
            type:'image',
            rect:['501px','0px','503px','400px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"slideshow5.png",'0px','0px']
         },
         {
            id:'cubierta',
            display:'none',
   ...
   states: {
      "Base State": {
         ...
         "${_caption}": [
            ["style", "top", '408px'],
            ["color", "color", 'rgba(245,240,240,1.00)'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid10", tween: [ "style", "${_slideshow4}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid9", tween: [ "style", "${_slideshow3}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid11", tween: [ "style", "${_slideshow5}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid8", tween: [ "style", "${_slideshow2}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
