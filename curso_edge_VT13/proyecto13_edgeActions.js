...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // los alias más comunes para las clases de Edge
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_menu}", "click", function(sym, e) {
         ...
         sym.$('<iframe width="560" height="315" src="http://www.youtube.com/embed/Q0jmQWevFeY" frameborder="0" allowfullscreen></iframe>').appendTo(sym.$("video")); // Mostrar un elemento.
