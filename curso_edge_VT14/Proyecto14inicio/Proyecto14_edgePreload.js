...
if(document.addEventListener ){ 
   ...
   aLoader = [
    ...
    { load: "edge_includes/edge.1.5.0.min.js"},
          { load: "Proyecto14_edge.js"},
          { load: "Proyecto14_edgeActions.js"}];
...
dlContent={
   dom: [
   {
      ...
      type:'image',
      tag:'img',
      rect:['0px','0px','960px','360px','auto','auto'],
      fill:["rgba(0,0,0,0)",'images/photo1.png','0px','0px']
   },
   {
      id:'Text3',
      type:'text',
      rect:['23px','52px','190px','255px','auto','auto'],
      text:"Esta aplicación se vería mejor en navegadores más modernos. Actualiza a las últimas versiones, por favor.",
      align:"left",
      font:['Arial, Helvetica, sans-serif',24,"rgba(240,243,143,1.00)","normal","none","normal"]
   }]};//simpleContent
